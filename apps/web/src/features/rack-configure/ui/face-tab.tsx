    ...
    <section className="grid gap-4">
      ...
      <div className="flex items-center justify-between">
        ...
        <button
          ...
          className="rounded-xl border border-[var(--border-muted)] bg-white px-3 py-2 text-sm text-slate-700 shadow-sm hover:bg-slate-50"
        >
          Add Section
        </button>
      </div>
              ...
              return (
                <div key={section.id} className="grid grid-cols-[52px_1fr_72px_80px_36px] items-center gap-2 px-4 py-2.5 text-sm text-slate-700">
                  ...
                  <input
                    ...
                    step="0.1"
                    min="0.1"
                    className="rounded-xl border border-[var(--border-muted)] px-2.5 py-2 shadow-sm"
