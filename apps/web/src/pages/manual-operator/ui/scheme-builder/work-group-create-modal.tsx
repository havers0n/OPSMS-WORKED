...
export function WorkGroupCreateModal({
  isOpen,
  onClose,
  onCreate,
}: {
  ...
  const suggestions = ['כללי', 'חריגים', 'דחוף', 'סלולר', 'רכב', 'סיגריות', 'משטח 1', 'משטח 2'];
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40" onClick={handleClose}>
      ...
      >
        <div className="px-6 py-4 border-b border-gray-200">
          <h2 className="text-lg font-bold text-gray-900">יצירת קבוצת עבודה</h2>
        </div>

        <div className="px-6 py-4">
          <label className="block text-sm font-medium text-gray-700 mb-2">שם קבוצת העבודה</label>
          <input
            autoFocus
