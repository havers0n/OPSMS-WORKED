...
import { AlertCircle, PackagePlus, RefreshCw, Search, X } from 'lucide-react';
        ...
        <div className="flex items-start justify-between gap-3">
          <div>
            ...
            <div className="mt-2 flex flex-wrap gap-2">
              <span
                className={`rounded-full px-2 py-0.5 text-xs font-medium ${getOrderStatusColor(order.status)}`}
              >
