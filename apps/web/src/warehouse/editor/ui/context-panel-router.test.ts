...
vi.mock('@/warehouse/editor/model/editor-selectors', async () => {
  const actual = await vi.importActual<typeof import('@/warehouse/editor/model/editor-selectors')>(
    '@/warehouse/editor/model/editor-selectors'
  );
