import type { ActiveStorageWorkflow, EditorMode, ViewMode } from '@/warehouse/editor/model/editor-types';
import type { CanvasInteractionLevel, CanvasLOD } from '@/entities/layout-version/lib/canvas-geometry';
import { useSemanticZoom } from '@/warehouse/editor/model/use-semantic-zoom';
