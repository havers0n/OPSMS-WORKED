...
vi.mock('@/widgets/warehouse-editor/model/editor-selectors', () => ({
  ...
  useCancelPlacementInteraction: () => vi.fn(),
  useEditorSelection: () => mockSelection,
  useMarkActiveStorageWorkflowSubmitting: () => vi.fn(),
  useSelectedCellId: () => mockSelection.cellId,
  useSelectedRackActiveLevel: () => 0,
  useSetActiveStorageWorkflowError: () => vi.fn(),
  useSetCreateAndPlacePlacementRetry: () => vi.fn(),
  useSetPlacementMoveTargetCellId: () => vi.fn(),
  useSetSelectedCellId: () => vi.fn(),
  useSetSelectedContainerId: () => mockSetSelectedContainerId,
  useSetSelectedRackActiveLevel: () => vi.fn(),
  useStartPlacementMove: () => vi.fn(),
