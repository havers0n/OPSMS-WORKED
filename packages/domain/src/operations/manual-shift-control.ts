...
export const manualShiftOrderAshlamaSourceSchema = z.enum(['manual', 'check_unit']);
export type ManualShiftOrderAshlamaSource = z.infer<typeof manualShiftOrderAshlamaSourceSchema>;
...
export const manualShiftOrderSchema = z.object({
  ...
  checkStartedAt: z.string().nullable(),
...
export const bucketProductRollupResponseSchema = z.object({
  ...
  sourceZone: z.string().nullable().optional(),
  workBucketName: z.string().nullable().optional(),
  sourceLineName: z.string().nullable().optional(),
